# ============================================================
# FILE: database.py
# [PERUBAHAN] Sebelumnya pakai SQLAlchemy Core (raw SQL)
# Sekarang pakai Flask-SQLAlchemy (ORM)
#
# Perbedaan utama:
#   SEBELUM: create_engine + text() + conn.execute("SELECT ...")
#   SESUDAH: db.Model + db.session + db.query.all()
# ============================================================

from flask_sqlalchemy import SQLAlchemy

# [PERUBAHAN] db dibuat di sini, lalu di-init ke app dari app.py
# Ini pola "application factory" agar db bisa diimport ke app.py
db = SQLAlchemy()

# ============================================================
# MODEL / CLASS — setara dengan tabel di database
# ============================================================
