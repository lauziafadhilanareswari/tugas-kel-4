...
# ============================================================
# [PERUBAHAN] Konfigurasi Flask-SQLAlchemy
...
# [PERUBAHAN] Hubungkan db (dari database.py) ke app Flask ini
# db = SQLAlchemy(app) — tapi karena db dibuat terpisah,
# kita pakai db.init_app(app) agar lebih rapi (db tidak bergantung langsung ke app)
db.init_app(app)

# [PERUBAHAN] Buat semua tabel dan isi data awal saat pertama jalan
